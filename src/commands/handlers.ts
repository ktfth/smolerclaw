    ...
    case '?':
      ctx.tui.showSystem(
        [
          ...
          '  /budget /orcamento     Definir orcamento maximo (centavos)',
          '  /retry /repetir        Repetir ultima msg',
          '  /undo /desfazer        Desfazer alteracao',
          '  /search /buscar        Buscar na conversa',
          '  /lang /idioma          Definir idioma (pt, en, auto)',
          '  /ask /perguntar        Pergunta one-shot (nao salva na sessao)',
          '  /commit /commitar      Git commit com IA',
          '  /config                Mostrar caminho do config',
          '  /exit /sair /quit /q   Sair',
          '',
          'Negocios / Business:',
          '  /briefing /resumo      Briefing diario',
          '  /news /noticias        Radar de noticias (ex: /news tech)',
          '  /feeds /fontes         Listar fontes RSS (built-in + custom)',
          '  /addfeed /novafonte    Adicionar fonte RSS custom',
          '  /rmfeed /rmfonte       Remover fonte custom',
          '  /disablefeed           Desativar fonte built-in',
          '  /enablefeed            Reativar fonte',
          '  /open /abrir           Abrir app Windows (ex: /open excel)',
          '  /openfile /abrirarquivo Abrir arquivo com app padrao',
          '  /openurl <url>         Abrir URL no navegador',
          '  /apps /programas       Apps em execucao',
          '  /sysinfo /sistema      Recursos do sistema',
          '  /calendar /agenda /cal Calendario Outlook',
          '',
          'Pessoas / People:',
          ...
          '  /contacts /contatos     Listar contatos',
          ...
          '  /dashboard /painel      Painel geral de pessoas',
          '  /verificar /status      Energia, foco e Lokaliza',
          '  /chat                   Modo chat com pessoa cadastrada',
          '',
          'Monitor:',
          '  /monitor /vigiar     Monitorar processo (ex: /monitor nginx)',
          '  /monitor stop <nome> Parar monitoramento',
          '  /monitor list        Listar monitoramentos ativos',
          '',
          'Workflows:',
          '  /workflow /fluxo     Listar workflows',
          '  /workflow run <nome> Executar (ex: /workflow iniciar-dia)',
          '  /workflow info <n>   Detalhes de um workflow',
          '  /workflow delete <n> Remover workflow',
          '  /workflow enable/disable <n>  Ativar/desativar',
          '',
          'Macros / Atalhos:',
          ...
          '  /macro delete <n>    Remover macro',
          '  /macro enable/disable <n>  Ativar/desativar',
          '  /macro all           Listar todos (incluindo desativados)',
          '',
          'Pomodoro:',
          ...
          '',
          'Agendador / Scheduler:',
          '  /schedule /agendar       Agendar notificacao (once/daily/weekly)',
          '  /schedule list           Listar jobs agendados',
          '  /schedule info <id>      Detalhes de um job',
          '  /schedule run <id>       Executar job agora',
          '  /schedule delete <id>    Remover job',
          '  /schedule enable/disable <id>  Ativar/desativar',
          '  /schedules /agendamentos Listar todos os jobs',
          '',
          'Financas / Finance:',
          '  /entrada /income <$> <cat>  Registrar entrada',
          '  /saida /expense <$> <cat>   Registrar saida',
          '  /finance /balanco           Resumo mensal',
          '',
          'Auth:',
          '  /auth                Status de autenticacao',
          ...
          '',
          'Memos / Notes:',
          '  /memo /anotar /note  Salvar memo (ex: /memo senha wifi #casa)',
          '  /memos /notas        Buscar memos (ex: /memos docker, /memos #casa)',
          '  /tags /memotags      Listar tags',
          '  /rmmemo /rmnota      Remover memo',
          '',
          'Materiais / Materials:',
          '  /material /mat        Salvar material (ex: /mat titulo | conteudo)',
          '  /materials /materiais Listar/buscar materiais (#tag, @categoria)',
          '  /matcats /categorias  Listar categorias',
          '  /rmmat /rmmaterial    Remover material',
          '',
          'Memoria RAG / Local Search:',
          '  /index /indexar      Construir/atualizar indice RAG',
          '  /reindex             Reconstruir indice do zero',
          '  /memory /memoria     Buscar na memoria local (ou ver status)',
          '',
          'Arquivo / Archive:',
          ...
          '',
          'Empresas BR / Brazil OSINT (BrasilAPI + Registro.br):',
          '  /cnpj /empresa <cnpj>     Ficha publica de empresa',
          '  /cnpj refresh <cnpj>      Forca nova consulta (ignora cache)',
          '  /cep <cep>                Endereco completo por CEP',
          '  /whois-br /dominio-br     RDAP/WHOIS publico de dominios .br',
          '',
          'Tarefas / Tasks:',
          '  /task /tarefa           Criar tarefa (ex: /tarefa 18h buscar pao)',
          '  /tasks /tarefas         Listar pendentes (/tarefas all p/ todas)',
          '  /done /feito            Marcar como concluida',
          '  /rmtask /rmtarefa       Remover tarefa',
          '',
          'Projetos / Projects:',
          '  /project /projeto         Definir/ver projeto ativo',
          '  /project auto             Auto-detectar do diretorio atual',
          '  /projects /projetos       Listar todos os projetos',
          '  /session /sessao start    Iniciar timer de trabalho',
          '  /session /sessao stop     Parar timer',
          '  /session /sessao          Ver sessao ativa',
          '  /report /relatorio        Relatorio (today/week/month)',
          '  /opportunities /oportunidades  Listar oportunidades',
          '',
          'Vault / Backup:',
          '  /vault status        Integridade dos dados',
          '  /vault backup        Backup manual',
          '  /vault sync          Push backup para remote git',
          '  /vault init          Inicializar sistema de backup',
          '  /backup              Backup rapido',
          '',
          'Windows Agent (Avancado):',
          '  /clipboard /area     Ler clipboard (texto ou OCR de imagem)',
          '  /screen /tela        Analisar janelas em foco',
          '  /ps1 <script>        PowerShell inline (com safety guards)',
          '',
          'Integracoes / Integrations:',
          '  /m365                Microsoft 365 (Outlook, Calendar, Teams)',
          '  /gws                 Google Workspace (Gmail, Calendar, Drive)',
          '',
          'Meta-Learning:',
          '  /reflect /reflexao /aprender   Analisa uso e gera insights',
          '',
